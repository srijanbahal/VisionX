...
export default function Home() {
  ...
  return (
    <div className="space-y-10">
      {/* Upload Section */}
      <Card className="p-8 flex flex-col items-center justify-center border-dashed border-2 border-primary/40 bg-muted/50 shadow-lg">
      ...
      {/* Processing Options */}
      <Card className="p-8 flex flex-col items-center justify-center shadow-lg">
        <div className="flex items-center gap-3 mb-4">
